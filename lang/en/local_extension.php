...
$string['status_status_summary'] = '{$a->status} extension request on {$a->date} for {$a->length}.';
$string['status_status_summary_no_length'] = '{$a->status} extension request on {$a->date}.';

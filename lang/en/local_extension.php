...
$string['form_rule_itemname_help'] = '';
$string['form_rule_itemname'] = 'Trigger name';
$string['form_rule_parent_help'] = '';
$string['form_rule_parent'] = 'Parent Rule';
$string['form_rule_priority_help'] = '';
$string['form_rule_priority'] = 'Priority';
$string['form_rule_roles'] = 'Actionable';
$string['form_rule_roles_help'] = '';
$string['form_rule_select_approve'] = 'Approve';
$string['form_rule_select_subscribe'] = 'Subscribe';
$string['form_rule_time_elapsed_help'] = '';
...
$string['state_status_result_approved'] = 'Approved';
$string['state_status_result_cancelled'] = 'Cancelled';
$string['state_status_result_denied'] = 'Denied';
$string['state_status_result_pending'] = 'Pending';

...
$string['form_rule_select_downgrade'] = 'Downgrade';
...
$string['template_notify_content'] = '{{course}} {{module}} {{student}} {{duedate}} {{extensiondate}} {{requeststatusurl}} {{extensionlength}}';
$string['template_notify_subject'] = 'Extension Request: {{extensionlength}} - {{student}} - {{course}} ';
$string['template_user_content'] = '{{course}} {{module}} {{student}} {{duedate}} {{extensiondate}} {{requeststatusurl}} {{extensionlength}}';
$string['template_user_subject'] = 'Extension Request: {{extensionlength}} - {{student}} - {{course}} ';

...
$string['form_rule_label_elapsed_length'] = 'If the request is';
...
$string['form_rule_label_request_length'] = 'If the requested length is';
$string['form_rule_label_set_roles'] = 'Set all roles equal to';
